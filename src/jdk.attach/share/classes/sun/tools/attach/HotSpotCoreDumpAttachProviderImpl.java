 ...
 */
public class HotSpotCoreDumpAttachProviderImpl extends AttachProviderImpl {

    public HotSpotCoreDumpAttachProviderImpl() {
    }
    ...
    public VirtualMachine attachVirtualMachine(String vmid, Map<String, ?> env)
        ...
        if (!OperatingSystem.isLinux() && !OperatingSystem.isWindows()) {
            throw new AttachNotSupportedException("OS not implemented");
        }
